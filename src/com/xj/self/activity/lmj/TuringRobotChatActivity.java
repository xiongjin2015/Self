...
import com.xj.self.adapter.ChatMessageAdapter;
...
public class TuringRobotChatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turing_robot_chat);
    ...
    private void initView() {
        ...
        mMsg = (EditText) findViewById(R.id.chat_msg);
        mDatas.add(new ChatMessage(Type.INPUT, "我是习近平，很高兴为您服务"));       
    }
