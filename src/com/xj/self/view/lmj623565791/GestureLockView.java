...
public class GestureLockView extends View {
    ...
    private final static String TAG = "GestureLockView";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /**绘制三角形，初始时个默认箭头朝上的一个等腰三角形，用户绘制结束后，根据由两个GestureLockView决定需要旋转多少度*/
    ...
    /**
     * 判断当前状态，绘制不同的显示效果；状态的改变都是GestureLockViewGroup的onTouchEvent中设置的。
     */
    @Override
